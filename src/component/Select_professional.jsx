            ...
            <div className="main-container">
                <div className="wrapper">
                    <div className="professional-container">
                        <div className="card any-professional">
                            <div className="icon">
                                <img src="group-icon.png" alt="Any Professional" />
                            </div>
                            <h3>Any professional</h3>
                            <p>for maximum availability</p>
                        </div>

                        <div className="card">
                            <div className="placeholder">J</div>
                            <div className="rating">
                                <span>4.9 ★</span>
                            </div>
                            <h3>Jawaher</h3>
                            <p>Hairdresser & Stylist</p>
                        </div>
                ...
                <div id="full-absolute">
                <div className="absolute m-4 text-white bg-slate-700" onClick={movetoTime}>
                    <div className="back-dir">z-</div>
                </div>
                </div>
                    <div className="selected-service" id="right">
                    <div className="selected-service-div">
                        ...
                        <div className="bottom-part">
                            ...
                            <div className="bottom-bottom">
                                <button className="contactButton" onClick={navigateTo}>
                                    Continue
...
export default Select_professional
